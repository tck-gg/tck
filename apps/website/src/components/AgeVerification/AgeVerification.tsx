...
function AgeVerification() {
  ...
  return (
    <Modal
      isOpen={ageVerification.isOpen}
      open={ageVerification.open}
      close={ageVerification.close}
    ...
    >
      <div className={classes.info}>
        ...
        <p className={classes.description}>
          By clicking continue, you agree you are of legal age in your country of residence. You
          also confirm you are residence in a country where the Curaçao casino license is legal for
          promotion (this list does not include Denmark).
        </p>
      </div>
