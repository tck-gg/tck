...
const GLOWS: {
  ...
  clash: (
    <svg
      ...
      xmlns='http://www.w3.org/2000/svg'
    >
      <g filter='url(#filter0_f_1469_6)'>
        <circle cx='589.881' cy='248.03' r='157.881' fill='url(#paint0_linear_1469_6)' />
      </g>
      <g filter='url(#filter1_f_1469_6)'>
        <circle cx='835.913' cy='440.119' r='157.881' fill='url(#paint1_linear_1469_6)' />
      </g>
      <g filter='url(#filter2_f_1469_6)'>
        <circle
          cx='1067.47'
          cy='326.97'
          r='157.881'
